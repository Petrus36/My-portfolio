  ...
  const projects = {
    sk: [
      ...
      },
      {
        ...
        description: 'Komplexné e-commerce riešenie s platobnou integráciou a administračným panelom.',
        longDescription: 'Táto komplexná e-commerce platforma má moderný, responzívny dizajn s bezproblémovým používateľským zážitkom. Postavená na Reacte a Node.js, obsahuje používateľskú autentifikáciu, správu produktov, nákupný košík a bezpečné spracovanie platieb. Administračný panel poskytuje analytiku a správu zásob.',
    ...
    en: [
      ...
      },
      {
        ...
        longDescription: 'This comprehensive e-commerce platform features a modern, responsive design with seamless user experience. Built with React and Node.js, it includes user authentication, product management, shopping cart functionality, and secure payment processing. The admin dashboard provides analytics and inventory management capabilities.',
        technologies: ['React', 'TypeScript', 'Node.js', 'MongoDB', 'Stripe', 'Tailwind CSS'],
        imageUrl: '/project1.jpg',
        githubUrl: 'https://github.com',
        liveUrl: 'https://example.com',
